    ...
    >
      ...
      <div className='flex flex-col pt-40 md:pt-0 select-none'>
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Jovanni</span>
          <span className='seq'> Morales</span>
        </h1>
        <p>
          <span
            ref={typedEl}
            className='seq text-3xl sm:text-md text-gray-light-3 font-mono leading-relaxed'
          ></span>
        </p>
        <div className='seq'>
          <Profiles />
      ...
      <div
        className='absolute  bottom-1.5 sm:w-[10%] sm:p-10 md:w-[30%] md:right-12 lg:visible lg:w-4/12 lg:right-12 2xl:right-16 '
        ref={lottieRef}
      ></div>
    </section>
  );
